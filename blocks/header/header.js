...
import {
  getUser, onAuthChange, logout, formatPoints,
...
export default async function decorate(block) {
  ...
  // login-state wiring (demo): swap utility labels by auth state; the login
  // surface itself is the shared React island (scripts/login-island.js),
  // fetched on first click — first paint carries zero React.
